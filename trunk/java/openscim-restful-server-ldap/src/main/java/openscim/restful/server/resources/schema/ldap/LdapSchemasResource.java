...
public class LdapSchemasResource extends SchemasResource
{
	...
	public Response listSchemas(UriInfo uriInfo, String resource)
	{
		...
		return ResourceUtilities.buildErrorResponse(HttpStatus.NOT_IMPLEMENTED, HttpStatus.NOT_IMPLEMENTED.getMessage() + ": Service Provider does not support the list schemas operation");
	}
}
